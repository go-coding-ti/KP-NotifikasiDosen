...
<div class="container-fluid">
    ...
    <form method="POST" enctype="multipart/form-data" action="{{route('botsetting-store')}}">
    @csrf
            ...
            <div class="row">
                <div class='col'>
                    ...
                    <select class="form-control" id="jenis_bot" name="jenis_bot">
                        <option value="" selected>Pilih Jenis Bot</option>
                        <option value="1">Bot Kepangkatan</option>
                        <option value="2">Bot Pensiun</option>
                        <option value="3">Bot Tugas Belajar</option>
                    </select>
                ...
                <div class='col'>
                    ...
                    <select class="form-control" id="periode" name="periode">
                        <option value="" selected>Pilih Periode Pengiriman Notifikasi</option>
                ...
                <div class='col'>
                    ...
                    <select class="form-control" id="waktu" name="waktu">
                        <option value="" selected>Pilih Waktu Pengiriman Notifikasi</option>
                ...
                <div class='col'>
                    ...
                    <select class="form-control" id="aksespetinggi" name="aksespetinggi">
                        <option value="" selected>Pilih Opsi Notifikasi Petinggi</option>
                ...
                <div class='col'>
                    ...
                    <select class="form-control" id="aksesadmin" name="aksesadmin">
                        <option value="" selected>Pilih Opsi Notifikasi Admin</option>
                        <option value="1">Hidup</option>
                        <option value="0">Mati</option>
                    </select>
                    <small style="color: red">
                ...
                <div class='col'>
                    ...
                    <select class="form-control" id="akseskoprodi" name="akseskoprodi">
                        <option value="" selected>Pilih Opsi Notifikasi Koprodi</option>
                        <option value="1">Hidup</option>
                        <option value="0">Mati</option>
                    </select>
                    <small style="color: red">
